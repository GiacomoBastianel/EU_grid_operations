...
grid = _PM.parse_file(joinpath(input_folder,grid_file))
timeseries = JSON.parsefile(joinpath(input_folder,timeseries_file))
...
zone_grid, wind_farms = add_offshore_wind_farms!(zone_grid)
