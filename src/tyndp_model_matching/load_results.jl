...
function load_results_STERNA(folder_results,scenario, climate_year; file_name = "result_zonal_tyndp")
    result_file_name =   joinpath(folder_results,"$(file_name)_$(scenario)_$(climate_year).json")
    input_file_name =    joinpath(folder_results,"input_zonal_tyndp_$(scenario)_$(climate_year).json")
    scenario_file_name = joinpath(folder_results,"scenario_zonal_tyndp_$(scenario)_$(climate_year).json")
